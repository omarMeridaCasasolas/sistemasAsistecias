<?php
    ...
    class MateriaDocente extends Conexion{
        ...
        public function obtenerDocentesAsignados_acoplado($sis_materia){
            ...
            $sql = "SELECT docente.id_docente, docente.sis_docente, docente.nombre_docente from docente, materia_docente where docente.id_docente = materia_docente.id_docente and materia_docente.id_materia=:id_mat";
            $this->sentenceSQL = $this->connexion_bd->prepare($sql);
