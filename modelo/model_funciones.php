...
//listarTableDocente()
    ...
    class Funcionalidad extends Conexion{
        ...
        public function mostrarFunciones($cargo){
            $sql = "SELECT * FROM funcionalidad WHERE id_cargo_trabajo IN (SELECT id_cargo_trabajo FROM cargo_trabajo WHERE cargo_similar =:cargo)" ;
            $sentenceSQL = $this->connexion_bd->prepare($sql);
            $sentenceSQL->execute(array(":cargo"=>$cargo));
