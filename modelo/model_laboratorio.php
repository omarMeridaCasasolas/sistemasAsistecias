<?php
    ...
    class Laboratorio extends Conexion{
        ...
        public function editarLaboratorio($nomLaboratorio,$codLaboratorio,$fecLaboratorio,$desLaboratorio,$mesLaboratorio,$horLaboratorio,$idLaboratorio){
            $sql = "UPDATE laboratorio SET nombre_laboratorio = :nombre ,fecha_creacion_lab = :fecha, siglas_laboratorio = :codigo, duracion_laboratorio = :mes, descripcion_laboratorio = :descripcion ,horas_trab_mes = :hora WHERE id_laboratorio = :id";
            $sentenceSQL = $this->connexion_bd->prepare($sql);
