    ...
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark d-inline-block w-100">
        ...
        <ul class="navbar-nav">
            ...
            <div class="dropdown-menu">
                ...
                <a class="dropdown-item" href="historial_dpa_laboratorio">Aux. Laboratorio</a>
            </div>
            </li>
        </ul>
    </nav>
<body class="bg-secondary">
    ...
    <!-- Historial de reportes-->
            ...
            <div class="modal-dialog">
                ...
                <!--modal body-->
                    <div class="modal-body">
                        ...
                        <h6 id="linkReporte"><strong>Link: </strong> <a href="#" target="_blank" rel="noopener noreferrer" id="documentoReporte">Enlace</a></h6>
                        ...
                        <div class="form-group">
                            <label for="idAsistencia">Calificacion de asistencia :</label>
                            <select name="idAsistencia" id="idAsistencia" disabled class="form-control">
                                <option value="undefined">Todavia</option>
        ...
        <script src="src/historial_reportes_uti_laboratorio.js"></script> 
