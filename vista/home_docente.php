                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form action="../controlador/licenciaDocente.php" method ="POST" id="formFechas">
                                <input type="text" style="display: none;" name="ident" id="ident" value="<?php echo $_SESSION['idDocente'];?>">
