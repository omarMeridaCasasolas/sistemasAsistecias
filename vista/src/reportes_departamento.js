    ...
    $("#tipoUnidad").change(function (e) {
        ...
        switch (tipoUnidad) {
            ...
            case "Laboratorios":
                ...
                break;
            case "Docente":
                document.getElementById("seccionAuxiliaresLaboratorio").style.display = "none";
                document.getElementById("seccionFiltrosBusqueda").style.display = "";
                cargarSelectGestion();
                break;
            default:
                break;
        ...
        switch (tipoUnidad) {
            ...
            case "Docente":
                if($("#selectListarReportes option:selected").val() == "ReportesPendientes"){
                    ...
                    //Mostramos las secciones requeridas del modalFormularioControlAvance
                    document.getElementById("seccionOpcionAsistencia").style.display = "";
                    document.getElementById("seccionBotonesModal").style.display = "";
                }else{
                    document.getElementById("divReportesDocente").style.display = "";
                    cargarTablaReportesRevisadosDocente();
                    //Ocultamos las secciones que no son requeridas del modalFormularioControlAvance
                    document.getElementById("seccionOpcionAsistencia").style.display = "none";
                    document.getElementById("seccionBotonesModal").style.display = "none";
                } 
                break;
    ...
    $(document).on("click", "#btnEnviarReporte", function(){  
        ...
        if(revisionCompleta){
            Swal.fire({
                ...
                text: "Una vez enviado a la UTI, no podra hacer ninguna modificacion",
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    ...
                    let datos = {
                        clase: "Clase",
                        metodo: "actualizarRevisionJefeDepartamento",
...
function cargarTablaReportesPendientesDocente(){
    ...
    let datos = {
        clase: "Clase",
        metodo: "obtenerReportesPendientesDocente",
...
function cargarTablaFormularioControlAvanceDocente(sis_docente, array_periodo_reporte){
    ...
    let datos = {
        clase: "Clase",
        metodo: "obtenerFormularioControlAvanceDocente",
        id_departamento: idDepartamento,
...
function cargarEnlacesRecursosModalFormularioControlAvance(arrayEnlacesRecursos){
    ...
    tituloEnlaces.innerHTML = "No existen enlaces registrados";
    tituloRecursos.innerHTML = "No existen recursos registrados";
