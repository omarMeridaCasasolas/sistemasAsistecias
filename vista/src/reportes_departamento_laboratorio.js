var listaMateriaJson, tablaLaboratorio;
$(document).ready(function (){
    ...
    tablaLaboratorio =$("#tablaReporte").DataTable({
        ...
        "ajax":{
            "method":"POST",
            "data" : {'clase': 'AuxiliarLaboratorio' , 'metodo':'obtenerReportesLaboratorioSem','fechaInicio': fechaInicio,'fechaFinal': fechaFinal, 'idDepartamento': $("#idDepartamento").val()},
