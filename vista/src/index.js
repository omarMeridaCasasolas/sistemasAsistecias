            ...
            if(propiedadUno == "error"){
                switch (valorUno) {
                    case "auntentificacion":
                        swal("Problema de autentificacion", "El usuario no existe!", "error");
                        break;
                    default:
                        break;
                }
            ...
            if(propiedadDos == "tipo"){
                switch (valorDos) {
                    ...
                    case "laboral":
                        $("#idItemUno").removeClass("active");
                        $("#idLinkUno").removeClass("active");
                        $("#idItemSeis").addClass("active");
                        $("#idLinkSeis").addClass("active");
                        $("#indice").removeClass("active");
                        $("#indice").addClass("fade");
                        $("#personalLaboral").removeClass("fade");
                        $("#personalLaboral").addClass("active");
                        break;
                    default:
                        break;
                }
