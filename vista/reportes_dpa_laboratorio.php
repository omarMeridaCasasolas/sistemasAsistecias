...
<body class="bg-secondary">
    <main class="container bg-white p-3 min-vh-100">
        ...
        <form action="../controlador/obtenerReportesLaboratorio.php" id="" method="POST">
            <div class="row">
        ...
        ?>
        <hr>
        <form action="getHTMLPDFLaboratorio.php" method="POST" target="_blank">
            <div class="text-center">
                ...
                <a href="vista_previa_reporte_laboratorio.php" class="btn btn-primary m-2" id="enlaceVistaPrevia">Vista previa</a>
    ...
    <script src="src/reportes_dpa_laboratorio.js"></script>
</body>
</html>
