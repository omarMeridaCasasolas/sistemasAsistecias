...
<body class="bg-secondary">
    ...
    <main class="container bg-white p-2">
        ...
        <div class="text-center"> <a href="personal_laboratorio.php" class="btn btn-primary"><i class="fas fa-vial"></i> Laboratorios</a> <a href="personal_clases.php" class="btn btn-primary"><i class="fas fa-door-open"></i> Clases</a> <a href="asignacion_materia_grupo.php" class="btn btn-primary"><i class="fas fa-chalkboard-teacher"></i> Asignaciones</a> <a class="btn btn-primary" href="reportes_departamento.php"><i class="fas fa-file-signature"></i>Reportes</a>
